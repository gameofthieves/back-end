...
exports.parse = (data, user) => {
  ...
  if (message.slice(0, 1) === '@') {
    ...
    case '@join':
      ...
      if (server.all[descriptor].players.length === 3) {
    ...
    case '@action': {
      ...
      switch (user.role) {
      case 'LOCKSMITH':
        roles.locksmith.action(descriptor, user);
        break;
      case 'COP':
        roles.cop.action(descriptor, user);
        break;
      case 'CREEPER':
        roles.creeper.action(descriptor, user);
        break;
      case 'DENTIST':
        roles.dentist.action(descriptor, user);
        break;
      case 'JAILOR':
        roles.jailor.action(descriptor, user);
        break;
      case 'THIEF':
        roles.thief.action(descriptor, user);
        break;
      case 'THIEF RECRUITER':
        roles.thiefrecruiter.action(descriptor, user);
        break;
      }
    ...
    if (user.currentServer === 'home' || server.all[user.currentServer].phase === 'day') {
