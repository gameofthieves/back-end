...
`)));
  ...
  function phase() {
    ...
    if (server.all[user.currentServer].phase === 'day') {
      ...
      server.all[user.currentServer].interval = setInterval(phase, 30000); // 30s night phase
      ...
      server.all[user.currentServer].interval = setInterval(phase, 30000); // 1 minute for day phase
      interval = server.all[user.currentServer].interval;
